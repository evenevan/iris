...
function recentGamesFormatter({ last_login, last_logout, recentGamesData = [], }) {
    const recentGames = [];
...
function processAGame({ date = null, ended = null, gameType = null, mode = null, map = null, }) {
    return {
        startMS: date,
        endMS: ended,
...
function bedwarsStats({ level = 0, coins = 0, wins_bedwars = 0, games_played = 0, winstreak = 0, final_k_d = 0, k_d = 0, }) {
    return {
        level: level,
        coins: coins,
        wins: wins_bedwars,
...
function duelsStats({ coins = 0, packages = [], kd_ratio = 0, win_loss_ratio = 0, wins = 0, kills = 0, deaths = 0, }) {
    return {
        coins: coins,
...
function pitStats({ gold_earned = 0, prestige = 0, playtime_minutes = 0, max_streak = 0, chat_messages = 0, kd_ratio = 0, kills = 0, deaths = 0, }) {
    return {
        gold: gold_earned,
        prestige: prestige,
...
function skywarsStats({ level = 0, coins = 0, kill_death_ratio = 0, win_loss_ratio = 0, wins = 0, kills = 0, deaths = 0, }) {
    return {
        level: level,
        coins: coins,
...
function megaWallsStats({ coins = 0, kill_death_ratio = 0, win_loss_ratio = 0, wins = 0, kills = 0, deaths = 0, }) {
    return {
        coins: coins,
        KD: maxDecimals(kill_death_ratio),
        WL: maxDecimals(win_loss_ratio),
