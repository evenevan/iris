...
export default {
  ...
  stats: {
    ...
    uhc: '<br><strong>%{possesive}% Stats for UHC Champions:</strong><br>&nbsp;<b>Level:</b> %{level}%<br>&nbsp;<b>Coins:</b> %{coins}%<br>&nbsp;<b>K/D Ratio:</b> %{KD}%<br>&nbsp;<b>W/L Ratio:</b> %{WL}%<br>&nbsp;<b>Wins:</b> %{wins}%<br>&nbsp;<b>Kills:</b> %{kills}%<br>&nbsp;<b>Deaths:</b> %{deaths}%<br>',
